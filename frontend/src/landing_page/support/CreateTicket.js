        ...
        <div className="container">
            <div className="row p-5 mt-5 mb-5">
                ...
                <div className="col-4 p-5 mt-2 mb-2">
                    <h4 className="fs-5 mb-4"><i class="fa fa-plus-circle" aria-hidden="true"></i> Account Opening</h4>
                    ...
                    <a href="" style={{textDecoration:'none', lineHeight:"2"}}>Charges at Zerodha</a><br/>
                    <a href="" style={{textDecoration:'none', lineHeight:"2"}}>Zerodha IDFC FIRST Bank 3-in-1 Account</a><br/>
                    <a href="" style={{textDecoration:'none', lineHeight:"2"}}>Getting Started</a><br/>
                </div>
                <div className="col-4 p-5 mt-2 mb-2">
                    <h4 className="fs-5 mb-4"><i class="fa fa-user" aria-hidden="true"></i> Your Zerodha Account</h4>
                    <a href="" style={{textDecoration:'none', lineHeight:"2"}}>Login Creditials</a><br/>
                ...
                <div className="col-4 p-5 mt-2 mb-2">
                    <h4 className="fs-5 mb-4"><i class="fa fa-bar-chart" aria-hidden="true"></i> Your Zerodha Account</h4>
                    ...
                    <a href="" style={{textDecoration:'none', lineHeight:"2"}}>Stockereports+</a><br/>
                    <a href="" style={{textDecoration:'none', lineHeight:"2"}}>GTT</a><br/>
                </div>

                <div className="col-4 p-5 mt-2 mb-2">
                    <h4 className="fs-5 mb-4"><i class="fa fa-credit-card" aria-hidden="true"></i> Funds</h4>
                ...
                <div className="col-4 p-5 mt-2 mb-2">
                    <h4 className="fs-5 mb-4"><i class="fa fa-circle-o-notch" aria-hidden="true"></i> Console</h4>
                    ...
                    <a href="" style={{textDecoration:'none', lineHeight:"2"}}>60 Day Challange</a><br/>
                ...
                <div className="col-4 p-5 mt-2 mb-2">
                    <h4 className="fs-5 mb-4"><i class="fa fa-circle-thin" aria-hidden="true"></i>5Coin</h4>
